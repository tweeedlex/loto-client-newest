  ...
  ws.onmessage = async (event) => {
    ...
    switch (msg.method) {
      ...
      case "openGame":
        ...
        break;
      case "sendNewCask":
        impLotoGame.createCask(msg.cask, msg.caskNumber, msg.pastCasks);
      ...
      case "winGame":
        console.log(msg);
        impLotoGame.checkWin(msg.winners, msg.bank, msg.winnersAmount, ws);
        break;
...
export async function openLotoRoom(ws, roomId) {
  ...
  if (isGameStarted.data == true) {
    ...
    console.log(isPlayerInRoom.data);
...
function updateBank(bank) {
  ...
  if (lotoGameInfo) {
    ...
    lotoBank.querySelector("span").innerHTML = `${bank}p`;
  }
}
